...
const Post = ({ post }: Props) => {
  ...
  return (
    <main>
      ...
      <article className="mx-auto max-w-3xl p-5">
        ...
        <div className="mt-10">
          <PortableText
            ...
            projectId={process.env.NEXT_BUBLIC_SANITY_PROJECT_ID!}
            content={post.body}
            serializers={{
              h1: (props: any) => (
      ...
      <hr className="boder my-5 mx-auto max-w-lg border-green-500" />
      {submitted ? (
        <div
          className="mx-auto flex max-w-2xl flex-col bg-green-500
       py-10 px-10 text-white"
        >
        ...
        >
          ...
          shadow outline-none ring-green-500 focus:ring"
